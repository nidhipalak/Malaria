...
The following analysis will look into malaria prevention measures shown to be effective in managing malaria globally. 
...
* __Childhood mortality under age 5__: number of deaths per 100,000 individuals. The available data ranges from the years 1990 through 2017.

* __% of ITN Usage by children under 5__: % of children under 5 who sleep under a bednet. The available data ranges from the years 1999 - 2017.

__Data Sources__

Both variables came from separate datasets that were gathered via surveys and tracked globally across countries. The analysis used a combined dataset to understand the impact of bednets usage on childhood mortality. The team looked at multiple sources to access data available in a structured format and explored datasets from the [World Malaria Report 2019](https://www.who.int/publications/i/item/9789241565721), [UNICEF Data Warehouse](https://data.unicef.org/resources/data_explorer/unicef_f/?ag=UNICEF&df=GLOBAL_DATAFLOW&ver=1.0&dq=.MNCH_IPTP+MNCH_ITN+MNCH_ITN2+MNCH_ITNOWN+MNCH_ITNPREG+MNCH_MLRACT+MNCH_MLRCARE+MNCH_MLRDIAG..&startPeriod=2016&endPeriod=2020), and finally landed on using the [Our World in Data](https://ourworldindata.org/grapher/malaria-death-rates-by-age) since the dataset had the most bednets related data.
...
Based on the above graphs, you can see that ITN usage among children improves mortality rates by 4 children per 1000 children. 
