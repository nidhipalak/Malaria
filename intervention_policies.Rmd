...
complete_2_df_unnest =
  ...
  filter(year >= 2016) %>% 
  mutate(
    prevalance = cases_point / population_at_risk,
    prevalance_lower = cases_lower / population_at_risk,
    prevalance_upper = cases_upper / population_at_risk,
...
```{r}
ggplot(complete_2_df_unnest, aes(x))
```
