...
```{r}
children_itn = 
  itn_graphs(df = itn_df, xaxis = prevalence, yaxis = percent_of_children_5_years_who_slept_under_an_itn)
```
...
children_itn = 
itn_df %>% 
  ggplot(aes(x = prevalence, y = percent_of_children_5_years_who_slept_under_an_itn)) +
  geom_point() + 
...
preg_women_itn = 
itn_df %>% 
  ggplot(aes(x = prevalence, y = percent_of_pregnant_women_who_slept_under_an_itn)) +
  geom_point() + 
...
household_itn = 
itn_df %>% 
  ggplot(aes(x = prevalence, y = percent_of_households_with_at_least_one_itn)) +
  geom_point() + 
...
children_itn_mort = 
itn_df %>% 
  ggplot(aes(x = mortality, y = percent_of_children_5_years_who_slept_under_an_itn)) +
  geom_point() + 
...
preg_women_itn_mort = 
itn_df %>% 
  ggplot(aes(x = mortality, y = percent_of_pregnant_women_who_slept_under_an_itn)) +
  geom_point() + 
...
household_itn_mort = 
itn_df %>% 
  ggplot(aes(x = mortality, y = percent_of_households_with_at_least_one_itn)) +
  geom_point() + 
...
prev_fits = bind_rows(fit_children_prev, fit_preg_prev, fit_household_prev) %>% filter(term != "(Intercept)")
```
...
mort_fits = bind_rows(fit_children_mort, fit_preg_mort, fit_household_mort) %>% filter(term != "(Intercept)")
```