...
```{r}
ggplotly(ggplot(est_cases_commodities_df, aes(x = year, y = prevalence, color = country)) + geom_point() + geom_line())

ggplotly(ggplot(est_cases_commodities_df, aes(x = year, y = mortality, color = country)) + geom_point() + geom_line() )
```
