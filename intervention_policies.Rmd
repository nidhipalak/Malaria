...
```{r}
ggplot(complete_2_df_unnest, aes(x = year, y = prevalence, color = country)) + geom_point() + geom_line() 

ggplot(complete_2_df_unnest, aes(x = year, y = mortality, color = country)) + geom_point() + geom_line() 
```

What percentage of those cases and deaths are attributed to pregnant women and children?