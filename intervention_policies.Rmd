...
itn_df %>% 
  ...
  ggplot(filtered_itn_df,aes(x = country)) +
  geom_point(aes(y = prevalence*100), color = "black") +
  # geom_line(aes(y = mortality), color = "red", linetype = "twodash") +
  geom_point(aes(y = percent_of_households_with_at_least_one_itn), color = "darkred", linetype = "twodash") +
  geom_point(aes(y = percent_of_pregnant_women_who_slept_under_an_itn), color = "blue", linetype = "dash")
```
...
filtered_itn_df %>% 
  ...
  ggplot(aes(x = percent_of_pregnant_women_who_slept_under_an_itn, color = mortality*100)) +
