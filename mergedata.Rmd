...
All the years are characters becasue the child_nets dataset has ranges of years. [Population protected by ITN or IRS](https://apps.who.int/gho/data/node.main.MALITNIRS?lang=en) and [Pregnant women attending ANC at least once and receiving IPTp3
Data](https://apps.who.int/gho/data/node.main.MALIPTP3?lang=en) do not seem to have any data.
