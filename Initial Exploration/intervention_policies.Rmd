...
complete_df %>% 
  ...
  drop_na(use_of_insecticide_treated_bed_nets_percent_of_under_5_population) %>% 
ggplot(aes(x = under_5_mortality_rate, y = use_of_insecticide_treated_bed_nets_percent_of_under_5_population, color = country)) + geom_point() +geom_line() + stat_smooth(method = "lm") + facet_wrap(country ~.)
```